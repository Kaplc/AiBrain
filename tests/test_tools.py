...
class TestStoreMemory:
    ...
    def test_store_returns_confirmation(self, mock_client):
        """存储成功后返回确认消息"""
        with patch("brain_mcp.tools.encode_texts", return_value=[[0.1] * 384]):
            from brain_mcp.tools import store_memory
    ...
    def test_store_upsert_correct_collection(self, mock_client):
        ...
        with patch("brain_mcp.tools.encode_texts", return_value=[[0.0] * 384]):
            from brain_mcp.tools import store_memory
...
class TestSearchMemory:
    ...
    def test_search_returns_list(self, mock_client):
        ...
        with patch("brain_mcp.tools.encode_texts", return_value=[[0.1] * 384]):
            from brain_mcp.tools import search_memory
...
class TestListMemories:
    ...
    def test_list_returns_list(self, mock_client):
        ...
        from brain_mcp.tools import list_memories
...
class TestDeleteMemory:
    ...
    def test_delete_returns_confirmation(self, mock_client):
        from brain_mcp.tools import delete_memory
